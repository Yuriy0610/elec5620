...
import { Home, Users, MessageCircle, Menu, LogOut, CircleCheckBig, Newspaper, ListChecks, SmilePlus, MessageSquare } from 'lucide-react';
...
const MainLayout = () => {
    ...
    const getInitials = (username) => {
        if (!username) return 'U'; // Default initials if username is not available
        return username
            .split(' ')
        ...
        <div className="flex h-screen bg-gray-100">
            ...
            <div className={`transition-all duration-300 ${isCollapsed ? 'w-16' : 'w-64'} bg-orange-800 text-white p-6`}>
                ...
                <nav className="space-y-4">
                    {[
                        { icon: Home, text: 'Home', to: '/main-layout/home' },
